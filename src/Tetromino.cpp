...
void Tetromino::Insert(const std::span<const Coordinates> coordinates, const Color& color)
{
...
bool Tetromino::IsValid(const std::span<const Coordinates> coordinates) const
{
